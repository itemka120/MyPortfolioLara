    ...
    theme.fn.intObs('.instagram-feed', function(){
        ...
        .done(function(data) {
            if( data.status == 'success' ) {
                ...
                console.log('Instagram Feed Error: Token file not found. If you did not setup your access token yet, please check the views documentation at "Instagram" section.');
            }
